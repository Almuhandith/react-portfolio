      ...
      <main className='bg-white px-3 md:px-20 lg:px-50 dark:bg-indigo-900 dark:text-white'>
        ...
        <section className=" min-h-screen pt-16 lg:pt-24">
          <div className='max-w-5xl mx-auto p-10 py-10'>
            ...
            <p className='text-md py-3 leading-8 text-indigo-800 md:text-xl max-w-xl dark:text-indigo-200'>
            I’m a software engineer specializing in building exceptional digital experiences
            </p>
          </div>
          <div className='text-5xl flex justify-center max-w-xl mx-auto gap-16 py-3 text-gray-600 dark:text-indigo-200'>
            <a href='#' className='hover:text-indigo-600 dark:hover:text-indigo-200'><AiFillTwitterCircle/></a>
            <a href='https://www.linkedin.com/in/abdulsamad-raji' target="_blank" rel='noreferrer' className='hover:text-indigo-600 dark:hover:text-indigo-200'><AiFillLinkedin/></a>
            <a href='https://www.github.com/Almuhandith' className='hover:text-indigo-600 dark:hover:text-indigo-200'><AiFillGithub/></a>
          </div>
        </section>
        {/* second page */}
        <section id='about' className='min-h-screen'>
          <div className='max-w-5xl mx-auto p-10 py-10'>
            ...
            <div className='lg:flex gap-10'>
              ...
              <div>
                <Image alt='' src={profile} height={250} width={250} className='transition ease-in-out contrast-75 hover:filter-none hover:-tranindigo-y-1 hover:scale-110 duration-700 mt-3'/>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* <section className='min-h-screen max-w-5xl mx-auto'>
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center justify-center shadow-lg p-10 rounded-xl my-10'>
              ...
              <h4 className='py-4 text-indigo-600'>Development languages and tools i use</h4>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>JavaScript</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>Python</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>MySQL</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>C</p>
            </div>
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              ...
              <h4 className='py-4 text-indigo-600'>Development languages and tools i use</h4>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>JavaScript</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>React</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>Typescript</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>NextJs</p>
            </div>
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              ...
              <h4 className='py-4 text-indigo-600'>Development languages and tools i use</h4>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>Flask</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>Python</p>
              <p className='text-indigo-800 py-1 dark:text-indigo-200'>MySQL</p>
            </div>
          </div>
